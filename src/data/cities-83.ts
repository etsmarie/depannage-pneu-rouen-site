...
export const CITIES_83: City[] = [
  {
    ...
    localContext: [
      ...
      "Sur les rocades A13, A28 et A150, ou coincé dans la congestion des quais bas de Seine, un pépin pneu tourne vite au cauchemar. Le trafic dense entre les ponts Flaubert, Mathilde et Guillaume-le-Conquérant laisse peu de place pour s'arrêter, et rejoindre la rive gauche ou le quartier Saint-Sever avec une roue morte est risqué. On se déplace jusqu'à votre point d'immobilisation, bande d'arrêt d'urgence comprise. Crevaison réparée, roue de secours montée ou pneus posés par paire, batterie relancée si elle a rendu les armes : l'intervention se fait sur place, sans remorquage.",
    ],
